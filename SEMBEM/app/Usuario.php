<?php namespace sembem;
    ...
    class  Usuario extends Model{
            ...
            */
            ...
            public static function msjPasswordModificado(){
                Session::flash('message',
                              ['mensaje' => 'Se modificó correctamente la Contraseña.',
                               'tipo' => 'success',
                               'msjinicial' => '¡ Éxito !'
                              ]);
            }
            ...
            public static function msjPreguntaModificada(){
                Session::flash('message',
                              ['mensaje' => 'Se modificó correctamente la Pregunta de Seguridad.',
                               'tipo' => 'success',
                               'msjinicial' => '¡ Éxito !'
                              ]);
            }
