...
class InsertarPersonalRequest extends Request
{
    /**
    ...
    public function rules()
    {
        $rules = [
            ...
            'p_cedula' => 'bail|required|digits_between:1,9|unique:persona,p_cedula',
            ...
            'p_correo' => 'bail|required|email|max:50|unique:persona,p_correo',
