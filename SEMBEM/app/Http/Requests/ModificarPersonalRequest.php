...
class ModificarPersonalRequest extends Request
{
    ...
    public function rules()
    {
        $rules = [
            ...
            $per = Personal::where('per_id_persona', $this->route->getParameter('personal'))->firstOrFail(),
            'per_nro_equipo'       => 'bail|alpha_dash|min:1|max:10|unique:personal,per_nro_equipo,'. $per -> id.',id',
    ...
    {
        $messages = [
            'p_fecha_nacimiento.before'       => 'Seleccione una Fecha de Nacimiento válida, el Personal debe ser mayor de edad.',
