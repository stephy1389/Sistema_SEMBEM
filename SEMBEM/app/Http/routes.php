...
Route::group(['middleware' => ['web']], function () {
	...
	*/
    Route::group(['prefix' => 'admin', 'namespace' => 'Administrador'], function(){
        ...
        //Para todo lo relacionado al Módulo de Exámenes Médicos más las seis de arriba
        Route::resource('examenmedico', 'ExamenMedicoController', ['only' => ['index', 'create', 'store', 'show', 'edit', 'update']]);

        //Para todo lo relacionado al módulo de Gestionar Perfil
        Route::resource('perfil', 'PerfilController', ['only' => ['index', 'create', 'store', 'show', 'edit', 'update']]);

        //Para mostrar el formulario de Modificar Pregunta de Seguridad en Gestionar Perfil
        Route::get('perfil/{perfil}/edit/pregunta', array('as' => 'admin.perfil.edit.pregunta', 'uses' => 'PerfilController@editPregunta'));

        //Para Recibir lo del formulario de Modificar Pregunta de Seguridad y Modificarla
        Route::put('perfil/{perfil}/pregunta', array('as' => 'admin.perfil.pregunta.update', 'uses' => 'PerfilController@updatePregunta'));
    });
