            ...
            <div class="col-md-8 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">CONSULTAR EXAMEN MÉDICO - CAMPOS OBLIGATORIOS (<font color="#DF0101">*</font>)</h3>
                    </div>
                    ...
                    <div class="panel-body">
                        {!! Form::model(Request::only(['p_cedula']),['route' => 'admin.examenmedico.index', 'method' => 'GET', 'class' => 'navbar-form navbar-left pull-left', 'role' => 'search']) !!}
