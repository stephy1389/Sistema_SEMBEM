            ...
            <div class="col-md-8 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">MODIFICAR EXAMEN MÉDICO</h3>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::model(Request::all(),['route' => ['admin.examenmedico.mod.filtros',$pacienteiden], 'method' => 'GET', 'class' => 'navbar-form navbar-left pull-right', 'role' => 'search']) !!}
                        ...
                        {!! Form::close() !!}
                            ...
                            @include('Administrador.ExamenMedico.Partials.FieldsModificar')
                        ...
                        {!! Form::open(['route' => 'admin.examenmedico.pacienteidentificado.edit.cedula', 'method' => 'GET']) !!}
                        <div align="right">
